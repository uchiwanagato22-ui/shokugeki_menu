  ...
  Future<void> _marquerPret(String docId) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content:
                Text("Plat marqué comme prêt ! 🍳 En attente de livraison.")),
      );
    } catch (e) {
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                stream: _db
                    ...
                    .orderBy('date_validation_caissier',
                        descending: false) // Premier arrivé, premier servi
                    .snapshots(),
                builder: (context, snapshot) {
                  ...
                  if (snapshot.data!.docs.isEmpty) {
                    return const Center(
                      child: Text(
                          "Aucun plat en commande. Les fourneaux sont calmes ! 🍩"),
                    );
                  }
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        shape: RoundedRectangleBorder(
                          side: BorderSide(
                              color: Colors.deepOrange.shade200, width: 1),
