...
class ClientOrdersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("SUIVI DE MES COMMANDES",
            style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildStep(
                            label: "Reçue", active: true, color: Colors.green),
                        _buildLine(
                            active: statut == "En cuisine" ||
                        ...
                        _buildStep(
                            ...
                            color: Colors.orange),
                        _buildLine(
                            active: statut == "En cours de livraison" ||
                                statut == "Livré"),
                        _buildStep(
                            label: "Livraison",
                            active: statut == "En cours de livraison" ||
                    ...
                    if (statut == "Rejeté / Fraude suspectée") ...[
                      ...
                      const Text(
                          "⚠️ Commande rejetée : Problème avec le reçu Bankily.",
                          style: TextStyle(
                              color: Colors.red,
                              fontWeight: FontWeight.bold,
                              fontSize: 12))
